...
----
oc get route datasphere-ui -n {datasphere-namespace}
----
...
====
In the OpenShift console, click *`{datasphere-namespace}`* in the project list.
In the left navigation, expand *Networking* and click *Routes*.
Click the URL in the *Location* column for `datasphere-ui`.

// SCREENSHOT NEEDED: Networking → Routes in {datasphere-namespace} showing the datasphere-ui route with its URL in the Location column
