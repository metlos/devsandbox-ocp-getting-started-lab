...
====
In the Core Platform view, click *`{datasphere-namespace}`* in the project list to open it.

// SCREENSHOT NEEDED: Core Platform Projects list with {datasphere-namespace} highlighted/selected, showing the click target
...
// SCREENSHOT NEEDED: Networking → Routes in {datasphere-namespace} showing datasphere-ui route with the URL in the Location column
