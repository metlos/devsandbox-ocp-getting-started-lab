...
====
In the Core Platform view expand the *console:qs-nav-home[Home]* menu item and click *`resource:project.openshift.io/v1/Project[scope=cluster,name={user}-datasphere,{user}-datasphere]`* in the 
resource:project.openshift.io/v1/Project[scope=cluster,*project list*] to open it.
...
In the left navigation, expand *console:qs-nav-networking[Networking]* and click resource:route.openshift.io/v1/Route[*Routes*].
