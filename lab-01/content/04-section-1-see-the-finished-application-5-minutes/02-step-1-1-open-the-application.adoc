...
====
In the Core Platform view, click *`resource:project.openshift.io/v1/Project[scope=cluster,name={user}-datasphere][{user}-datasphere]`* in the project list to open it.
