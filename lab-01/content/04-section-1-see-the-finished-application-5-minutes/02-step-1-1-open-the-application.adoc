...
====
In the Core Platform view expand the *console:qs-nav-home[Home]* menu item and click 
*`resource:project.openshift.io/v1/Project[{user}-datasphere,scope=cluster,name={user}-datasphere]`* in the 
resource:project.openshift.io/v1/Project[*project list*,scope=cluster] to open it.
