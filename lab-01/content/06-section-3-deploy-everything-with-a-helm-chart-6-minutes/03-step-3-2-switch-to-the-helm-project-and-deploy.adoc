...
Switch to `{lab-namespace}-helm` -- this is a separate, clean namespace for the Helm deployment:
...
====
In the Project selector, switch to *`{lab-namespace}-helm`*.
...
// SCREENSHOT NEEDED: Helm Releases page in {lab-namespace}-helm showing the datasphere release with Status: deployed and Revision: 1
