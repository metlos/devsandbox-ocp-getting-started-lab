...
// SCREENSHOT NEEDED: Topology view in {lab-namespace}-helm showing datasphere-ui, datasphere-api, AND datasphere-redis all deployed with solid blue rings (3 components from the Helm chart)
