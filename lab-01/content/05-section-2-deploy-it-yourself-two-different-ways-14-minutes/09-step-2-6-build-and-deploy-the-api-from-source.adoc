...
----
oc new-app python~{gitea-root-url}/{user}/datasphere-api --name=datasphere-api
----
...
Pushing image image-registry.openshift-image-registry.svc:5000/{lab-namespace}/datasphere-api:latest ...
Push successful
----
=====
...
. In the *Git Repo URL* field, paste: `{gitea-root-url}/{user}/datasphere-api`
